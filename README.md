...
### 🛡️ [PhishGuard](https://github.com/aminearea/phishguard)
Real-time phishing detection — Chrome extension + PHP REST API + admin dashboard.

`JavaScript` `PHP` `MySQL` `Manifest V3`
